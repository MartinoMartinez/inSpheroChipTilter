...
class ComDevice:
    def __init__(self, comPortName='', comPortFlags={}, userMsg='', logger=None):
        self.comPortList    = []
        ...
        if comPortName != '':
            self.DetectDeviceAndSetupPort(comPortName, comPortFlags, userMsg)
...
### -------------------------------------------------------------------------------------------------------------------------------
    ...
    def DetectDeviceAndSetupPort(self, comPortName='', flags={}, msg=''):
...
### -------------------------------------------------------------------------------------------------------------------------------
    ...
    def SaveReadFromComPort(self, mode='', **flags):
        ...
        # in case no connection possible
        else:
            inData = False
